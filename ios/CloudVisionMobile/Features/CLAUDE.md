...
|-----------|------|--------------|
| `Locate/` | F1 Endpoint Locator — find which switch/port a MAC, IP, or hostname is connected to. Surfaced under the **Search** tab. | Modifying endpoint search, result rendering, recent searches |
